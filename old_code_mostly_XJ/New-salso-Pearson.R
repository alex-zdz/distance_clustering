...
D = Pearson_distance_mixture(y, eam[1,], prior_list)
D2 = Pearson_distance_mixture(y, c_alloc_true, prior_list)

res_ini = Initialization_phase(eam, y, prior_list,Pearson_distance_mixture)
res_swt = Sweetening_phase(res_ini, y, prior_list,Pearson_distance_mixture)
res_zea = Zealous_updates_phase(res_swt, y, prior_list,Pearson_distance_mixture, n_max=10, k=10)
res_salso = Salso_whole_procedure(eam, y,prior_list,Pearson_distance_mixture, n_runs=10, n_max=10 )


Pearson_distance_mixture(y, res_ini, prior_list)
Pearson_distance_mixture(y, res_swt, prior_list)
Pearson_distance_mixture(y, res_zea, prior_list)
