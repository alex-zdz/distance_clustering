...
#22.01.2026 additionally here I am testing XJs methods with my own data generation function since it seems that the results were superior to binder and VI 
# due to the hardcoded means and standard deviations which resulted in binder and vi finding one cluster less which automatically resulted in a completely different ARI.

# as expected, with different simulated data our methods do not trump the binder loss, elthough they still perform better than the VI - for now I just tested 2 replications to 
# double check the suspiciously good results of XJ
