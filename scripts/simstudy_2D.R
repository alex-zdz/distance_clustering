...
# Pre-compute data and AntMAN fits for both scenarios (only once!)
cat("Generating data and computing AntMAN posterior fits for both scenarios ...\n")
...
cat("Files are in: results/simstudy/2D/\n")